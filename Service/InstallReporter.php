<?php
/**
 * Standalone install + heartbeat reporter for Panth_SearchAutocomplete.
 *
...
namespace Panth\SearchAutocomplete\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_SearchAutocomplete';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-search-autocomplete';
